	...
	<body>
		<section class="navbar">
		    <div class="container">
				...
				<?php
					if (isset($_SESSION['user'])){
						echo "<a id=\"goto-login\" href=\"logout.php\" title=\"Thoát\"><img src=\"picture/goto-login.png\"/></a>";
						echo "<p id=\"username\">" . $_SESSION['user'] . "!</p>";
					}
					else{ 
						echo "<a id=\"goto-login\" href=\"login.php\" title=\"Đăng nhập\"><img src=\"picture/goto-login.png\"/></a>";
					}
				?>
		    </div>
		</section>
		        	...
		        	<li id="buy-more-song" class="active">
		       		...
		       		<li id="get-signature">
		          		<a href="#getsignature" title="Get signature">
		            		<i class="fa fa-certificate"></i> Watermark Audio
		          		</a>
		       		</li>
		       		<?php
			...
			<table class="songstable">
				<thead>
					<tr>
						...
						<th class="col-xs-4">Tên ca sĩ</th>
